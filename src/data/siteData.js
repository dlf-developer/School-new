...
export const globalData = {
  ...
  awards: {
    ...
    timeline: [
      ...
      { id: 'aw-11', year: '2020-21', award: 'Brainfeed School Excellence Award – Prominent Category', by: 'Brainfeed', cat: 'Academic' },
      { id: 'aw-12', year: '2019-20', award: 'Ranked Among the Top 2 Schools of the City', by: 'Education World India School Rankings', cat: 'Ranking' },
