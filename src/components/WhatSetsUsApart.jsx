    ...
    <div className="pt-28 pb-16 min-h-screen text-brand-charcoal selection:bg-brand-gold/30">
      <div className="w-[96%] max-w-[1600px] mx-auto px-4 md:px-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
          {pillars.map((pillar) => (
            <div key={pillar.title} className="bg-white p-8 sm:p-12 rounded-3xl border border-brand-masterDeep/5 shadow-md space-y-4 hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-serif text-2xl font-bold text-brand-masterDeep">{pillar.title}</h3>
