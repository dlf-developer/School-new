      ...
      <div className="w-[96%] max-w-[1600px] mx-auto px-4 md:px-12">
        <div className="bg-brand-greenDeep rounded-3xl overflow-hidden p-6 sm:p-12 md:p-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative">
          ...
          <div className="lg:col-span-5 space-y-4 sm:space-y-6 text-brand-bg">
            ...
            <h3 className="font-serif text-2xl sm:text-4xl font-bold leading-tight">Can't Visit in Person? Take Our Virtual Tour</h3>
            <p className="text-xs sm:text-sm text-brand-bg/85 leading-relaxed font-inter">
              Step right inside our premium experiential labs, explore the zero-waste center, look around the sports grounds, and explore classrooms virtually.
            </p>
            <button 
            ...
            >
              <Aperture className="w-4 h-4" /> Start Immersive Tour
            </button>
          </div>
              ...
              {!isVideoPlaying && (
                <div className="absolute inset-0 bg-brand-greenDeep/40 flex items-center justify-center" id="video-overlay">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-white text-[10px] sm:text-xs font-semibold tracking-wider uppercase">Interactive Video Experience</p>
                  </div>
                </div>
              )}
            </div>
