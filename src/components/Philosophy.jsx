    ...
    <div className="pt-28 pb-16 min-h-screen text-brand-charcoal selection:bg-brand-gold/30">
      <div className="w-[96%] max-w-[1600px] mx-auto px-4 md:px-12 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <span className="text-xs uppercase tracking-widest font-extrabold text-brand-masterVibrant">Thinking School with a Soul</span>
          <h2 className="font-serif text-4xl sm:text-5xl font-bold text-brand-masterDeep">Our Philosophy</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
          <div className="bg-white p-8 sm:p-12 rounded-3xl border border-brand-masterDeep/5 shadow-md space-y-4">
            <h3 className="font-serif text-2xl font-bold text-brand-masterDeep">Vision & Mission</h3>
          ...
          <div className="bg-white p-8 sm:p-12 rounded-3xl border border-brand-masterDeep/5 shadow-md space-y-4">
            <h3 className="font-serif text-2xl font-bold text-brand-masterDeep">Institutional Recognition</h3>
            <p className="text-xs sm:text-sm text-brand-muted leading-relaxed font-inter">
